...
import 'package:finalproject/components/navigationBars/archedBar.dart';

class CustomBottomNavigationBar extends StatefulWidget {
  final Function(int) onIconPressedCallback; // Fixed the spelling of 'onIconPressedCallback'

  const CustomBottomNavigationBar({
    Key? key,
    required this.onIconPressedCallback, // Marked as required
  }) : super(key: key);
...
class _CustomBottomNavigationBarState extends State<CustomBottomNavigationBar>
  ...
  late AnimationController _xController; // Marked as 'late'
  late AnimationController _yController; // Marked as 'late'
  ...
  void _handlePressed(int index) {
    ...
    widget.onIconPressedCallback(index); // Fixed the spelling of 'onIconPressedCallback'
    setState(() {
